...
class TestScpsUrbandatasetSchema20UrbanDatasetSpecificationId(unittest.TestCase):
    """ScpsUrbandatasetSchema20UrbanDatasetSpecificationId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScpsUrbandatasetSchema20UrbanDatasetSpecificationId:
        """Test ScpsUrbandatasetSchema20UrbanDatasetSpecificationId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScpsUrbandatasetSchema20UrbanDatasetSpecificationId`
        """
        model = ScpsUrbandatasetSchema20UrbanDatasetSpecificationId()
        if include_optional:
            return ScpsUrbandatasetSchema20UrbanDatasetSpecificationId(
                value = '',
                scheme_id = ''
            )
        else:
    ...
    def testScpsUrbandatasetSchema20UrbanDatasetSpecificationId(self):
        """Test ScpsUrbandatasetSchema20UrbanDatasetSpecificationId"""
