...
class TestScpsUrbandatasetSchema20UrbanDatasetSpecificationPropertiesPropertyDefinitionInner(unittest.TestCase):
    """ScpsUrbandatasetSchema20UrbanDatasetSpecificationPropertiesPropertyDefinitionInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScpsUrbandatasetSchema20UrbanDatasetSpecificationPropertiesPropertyDefinitionInner:
        """Test ScpsUrbandatasetSchema20UrbanDatasetSpecificationPropertiesPropertyDefinitionInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScpsUrbandatasetSchema20UrbanDatasetSpecificationPropertiesPropertyDefinitionInner`
        """
        model = ScpsUrbandatasetSchema20UrbanDatasetSpecificationPropertiesPropertyDefinitionInner()
        if include_optional:
            return ScpsUrbandatasetSchema20UrbanDatasetSpecificationPropertiesPropertyDefinitionInner(
                property_name = '',
    ...
    def testScpsUrbandatasetSchema20UrbanDatasetSpecificationPropertiesPropertyDefinitionInner(self):
        """Test ScpsUrbandatasetSchema20UrbanDatasetSpecificationPropertiesPropertyDefinitionInner"""
