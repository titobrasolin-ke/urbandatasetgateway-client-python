...
class ScpsUrbandatasetSchema20UrbanDatasetContextProducer(BaseModel):
    """
    ScpsUrbandatasetSchema20UrbanDatasetContextProducer
    """ # noqa: E501
    id: StrictStr
    scheme_id: Optional[StrictStr] = Field(default=None, alias="schemeID")
    __properties: ClassVar[List[str]] = ["id", "schemeID"]
