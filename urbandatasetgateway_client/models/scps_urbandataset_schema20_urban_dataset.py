...
class ScpsUrbandatasetSchema20UrbanDataset(BaseModel):
    """
    ScpsUrbandatasetSchema20UrbanDataset
    """ # noqa: E501
    context: ScpsUrbandatasetSchema20UrbanDatasetContext
    specification: ScpsUrbandatasetSchema20UrbanDatasetSpecification
    values: ScpsUrbandatasetSchema20UrbanDatasetValues
    __properties: ClassVar[List[str]] = ["context", "specification", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "context": ScpsUrbandatasetSchema20UrbanDatasetContext.from_dict(obj["context"]) if obj.get("context") is not None else None,
            "specification": ScpsUrbandatasetSchema20UrbanDatasetSpecification.from_dict(obj["specification"]) if obj.get("specification") is not None else None,
            "values": ScpsUrbandatasetSchema20UrbanDatasetValues.from_dict(obj["values"]) if obj.get("values") is not None else None
        })
        return _obj
