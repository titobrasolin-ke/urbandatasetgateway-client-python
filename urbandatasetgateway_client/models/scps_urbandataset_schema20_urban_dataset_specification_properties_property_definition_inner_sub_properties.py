...
class ScpsUrbandatasetSchema20UrbanDatasetSpecificationPropertiesPropertyDefinitionInnerSubProperties(BaseModel):
    """
    ScpsUrbandatasetSchema20UrbanDatasetSpecificationPropertiesPropertyDefinitionInnerSubProperties
    """ # noqa: E501
    property_name: Annotated[List[StrictStr], Field(min_length=2)] = Field(alias="propertyName")
