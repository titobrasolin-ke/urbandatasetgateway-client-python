...
class ScpsUrbandatasetSchema20UrbanDatasetSpecification(BaseModel):
    """
    ScpsUrbandatasetSchema20UrbanDatasetSpecification
    """ # noqa: E501
    version: Optional[StrictStr] = None
    id: ScpsUrbandatasetSchema20UrbanDatasetSpecificationId
    name: StrictStr
    uri: StrictStr
    properties: Optional[ScpsUrbandatasetSchema20UrbanDatasetSpecificationProperties] = None
    __properties: ClassVar[List[str]] = ["version", "id", "name", "uri", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": ScpsUrbandatasetSchema20UrbanDatasetSpecificationId.from_dict(obj["id"]) if obj.get("id") is not None else None,
            "name": obj.get("name"),
            "uri": obj.get("uri"),
            "properties": ScpsUrbandatasetSchema20UrbanDatasetSpecificationProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
