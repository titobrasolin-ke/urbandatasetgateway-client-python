...
class ScpsUrbandatasetSchema20UrbanDatasetValuesLineInnerPropertyInner(BaseModel):
    """
    ScpsUrbandatasetSchema20UrbanDatasetValuesLineInnerPropertyInner
    """ # noqa: E501
    name: StrictStr
    val: Optional[StrictStr] = None
    var_property: Optional[Annotated[List[Optional[ScpsUrbandatasetSchema20UrbanDatasetValuesLineInnerPropertyInnerPropertyInner]], Field(min_length=2)]] = Field(default=None, alias="property")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScpsUrbandatasetSchema20UrbanDatasetValuesLineInnerPropertyInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScpsUrbandatasetSchema20UrbanDatasetValuesLineInnerPropertyInner from a dict"""
        if obj is None:
            return None
