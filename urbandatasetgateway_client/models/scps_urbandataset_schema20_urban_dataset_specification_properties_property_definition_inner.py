...
class ScpsUrbandatasetSchema20UrbanDatasetSpecificationPropertiesPropertyDefinitionInner(BaseModel):
    """
    ...
    property_description: Optional[StrictStr] = Field(default=None, alias="propertyDescription")
    data_type: Optional[StrictStr] = Field(default=None, alias="dataType")
    code_list: Optional[StrictStr] = Field(default=None, alias="codeList")
    ...
    sub_properties: Optional[ScpsUrbandatasetSchema20UrbanDatasetSpecificationPropertiesPropertyDefinitionInnerSubProperties] = Field(default=None, alias="subProperties")
