...
class SearchUrbanDatasetsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["resource_id", "period_start", "period_end", "center_latitude", "center_longitude", "distance"]
