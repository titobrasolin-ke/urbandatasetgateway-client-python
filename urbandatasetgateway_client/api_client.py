...
from urbandatasetgateway_client.api_response import ApiResponse, T as ApiResponseT
import urbandatasetgateway_client.models
from urbandatasetgateway_client import rest
from urbandatasetgateway_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(urbandatasetgateway_client.models, klass)
